      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-primary/5 p-12 lg:flex">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            Generate custom courses tailored to your experience level and master
            any topic instantly.
          </p>
        </div>
        ...
        <div className="relative z-10">
          <div className="mb-4 flex -space-x-4">
            <div className="size-12 rounded-full border-2 border-background bg-muted"></div>
            <div className="size-12 rounded-full border-2 border-background bg-muted/80"></div>
            <div className="size-12 rounded-full border-2 border-background bg-muted/60"></div>
            <div className="flex size-12 items-center justify-center rounded-full border-2 border-background bg-background text-xs font-medium">
              +1k
            </div>
          </div>
          <p className="text-sm font-medium text-foreground">
            Join thousands of learners generating custom courses.
          </p>
        </div>
      </div>
          ...
          <form onSubmit={onSubmit} className="grid gap-5">
            ...
            <div className="grid gap-2">
              ...
              <input
                ...
                disabled={isLoading}
                required
                className="flex h-10 w-full rounded-md border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:font-medium placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
              />
            </div>
